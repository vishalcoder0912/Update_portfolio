...
const ExternalIcon = () => <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6M15 3h6v6M10 14L21 3"/></svg>;
...
function TiltCard({ project, index, inView }) {
  ...
  return (
    <motion.article ref={ref} className="proj-card"
      ...
      <div className="proj-card__band" style={{ background: project.gradient }}>
        ...
        <div className="proj-card__glow" style={{ background: `radial-gradient(circle at 60% 40%, ${project.accent}22, transparent 65%)` }} />
      </div>
      ...
      <div className="proj-card__body">
        ...
        <div className="proj-card__actions">
          <a href={project.github} target="_blank" rel="noreferrer" className="paction paction--ghost" data-hover>
            <GithubIcon /> Code
          </a>
          {project.live && (
            <a href={project.live} target="_blank" rel="noreferrer" className="paction paction--solid" data-hover>
    ...
    <section id="projects" className="section projects" ref={ref}>
      <div className="container">
        ...
        <motion.p className="section-subtitle" initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.2 }}>
          Real-world projects spanning the MERN stack, systems programming, and finance tools.
        </motion.p>
        ...
        <div className="proj-grid">
          {list.map((p, i) => <TiltCard key={p.id} project={p} index={i} inView={inView} />)}
        </div>
      </div>
    </section>
  );
